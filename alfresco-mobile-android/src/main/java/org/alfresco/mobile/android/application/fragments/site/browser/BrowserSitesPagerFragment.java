...
public class BrowserSitesPagerFragment extends AlfrescoFragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        pageChangeListener.onPageSelected(SitesPagerAdapter.TAB_FAV_SITES);
        viewPager.setCurrentItem(SitesPagerAdapter.TAB_FAV_SITES);
...
{
    protected static final int TAB_ALL_SITES = 1;
...
//                break;
            default:
                ...
                fr = SearchSitesFragment.with(activity.get()).createFragment();
                break;
        }
        return fr;
    }
